...
export default function EditSessionPage() {
  ...
  const handleDelete = () => {
    ...
    if (!confirmed) return;
    const doubleCheck = window.confirm('This action is irreversible. Confirm again to proceed.');
            ...
            <div
              ...
              className={`cursor-pointer flex justify-between items-center border rounded p-4 shadow transition relative
                ${isCurrent
                  ...
                  : 'border border-gray-300 bg-white hover:shadow-md hover:border-blue-500 hover:bg-blue-50'}
              `}
            >
              <div>
